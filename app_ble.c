...
/* USER CODE BEGIN PD */
#define KEK_MAGIC_WORD       0xA5A5A5A5  /* Una firma arbitraria per dire "Chiave Presente" */

/* Nelle librerie HAL per WBA, i registri di backup si chiamano RTC_BKP_DRx o TAMP_BKPxR */
...
MSS_APP_ConnHandleNotEvt_t MSSHandleNotification;
WSS_APP_ConnHandleNotEvt_t WSSHandleNotification;
...
{
  7, AD_TYPE_COMPLETE_LOCAL_NAME, 'S', 'e', 'r', 'v', 'e', 'r',  /* Complete name */
...
/* USER CODE BEGIN PV */
static uint8_t ble_init_complete = 0;
...
/* USER CODE BEGIN PFP */
void APP_BLE_Watchdog_Refresh_If_Healthy(void);
/* USER CODE END PFP */
...
static uint8_t ble_stack_health_flag = 0;
/* USER CODE END EV */
    ...
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      if (p_disconnection_complete_event->Connection_Handle == bleAppContext.connectionHandle)
      {
        ...
        /* USER CODE BEGIN EVT_DISCONN_COMPLETE_2 */
			...
			LOG_INFO_APP("Advertising started after DISCONNECTION");
      ...
      MSSHandleNotification.EvtOpcode = MSS_DISCON_HANDLE_EVT;
      WSSHandleNotification.EvtOpcode = WSS_DISCON_HANDLE_EVT;
      DISHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      MSSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      WSSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      DIS_APP_EvtRx(&DISHandleNotification);
      MSS_APP_EvtRx(&MSSHandleNotification);
      WSS_APP_EvtRx(&WSSHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          MSSHandleNotification.EvtOpcode = MSS_CONN_HANDLE_EVT;
          WSSHandleNotification.EvtOpcode = WSS_CONN_HANDLE_EVT;
          DISHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          MSSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          WSSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          DIS_APP_EvtRx(&DISHandleNotification);
          MSS_APP_EvtRx(&MSSHandleNotification);
          WSS_APP_EvtRx(&WSSHandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          MSSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          WSSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          DIS_APP_EvtRx(&DISHandleNotification);
          MSS_APP_EvtRx(&MSSHandleNotification);
          WSS_APP_EvtRx(&WSSHandleNotification);
...
void APP_BLE_Watchdog_Refresh_If_Healthy(void) {
	if (ble_stack_health_flag == 1) {
		HAL_IWDG_Refresh(&hiwdg);
		ble_stack_health_flag = 0;
		LOG_INFO_APP("\n\rREFRESH IWDG");
	}
}
